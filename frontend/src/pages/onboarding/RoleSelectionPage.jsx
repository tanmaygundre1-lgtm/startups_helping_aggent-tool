        ...
        >
          <Card>
            ...
            <p style={{ marginBottom: "var(--space-md)" }}>
              I'm looking for talented people to help build my startup.
            </p>
            <Button onClick={() => navigate("/onboarding/founder")}>
              I am a Founder
            </Button>
          </Card>
          ...
          <Card>
            ...
            <p style={{ marginBottom: "var(--space-md)" }}>
              I want to use my skills and work with exciting startup ideas.
            </p>
